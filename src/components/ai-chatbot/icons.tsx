...
export function CheckCircle2Icon({ size = 14, className }: { size?: number; className?: string }) {
  return (
    <svg
      className={className}
      width={size}
...
export function SettingsIcon({ size = 15, className }: { size?: number; className?: string }) {
  return (
    <svg
      className={className}
      width={size}
...
export function PlusIcon({ size = 15, className }: { size?: number; className?: string }) {
  return (
    <svg
      className={className}
      width={size}
...
export function Trash2Icon({ size = 12, className }: { size?: number; className?: string }) {
  return (
    <svg
      className={className}
      width={size}
...
export function Loader2Icon({ size = 14, className }: { size?: number; className?: string }) {
  return (
    <svg
      className={className}
      width={size}
