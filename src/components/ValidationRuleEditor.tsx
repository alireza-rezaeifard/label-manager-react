  ...
  return (
    <div className="vre">
      ...
      <style>{`
        ...
        .vre-rule { display: flex; align-items: center; gap: 0.5rem; padding: 0.375rem 0.625rem; background: rgba(15, 118, 110, 0.04); border: 1px solid var(--border-color); border-radius: 6px; font-size: 0.75rem; }
        ...
        .vre-add-btn:hover { border-color: var(--primary); background: rgba(15, 118, 110, 0.04); }
      `}</style>
    </div>
  );
}